                        ...
                        <div>
                            <a href="#" data-toggle="dropdown" title="drlantern@gotbootstrap.com"
                               class="header-icon d-flex align-items-center justify-content-center ml-2">
                                ...
                                <div
                                    class="profile-photo_ex_sm rounded-circle d-flex align-items-center justify-content-center">
                                    <p class="text-center">
                            ...
                            <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                                <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                    <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                        <span class="mr-2">
                                             <div
                                                 class="profile-photo_md rounded-circle d-flex align-items-center justify-content-center">
                                                 <p class="text-center">
                                                    {{ substr(auth()->user()->profile->fname, 0, 1) }}{{ substr(auth()->user()->profile->lname, 0, 1) }}
                                                 </p>
                                             </div>
                                        </span>
