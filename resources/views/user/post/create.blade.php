            ...
            <div class="row">
                <div class="subheader">
                    <h1 class="subheader-title">
                        <i class='subheader-icon fal fa-plus-square'></i> Kullanıcı Talep Ekleme
                    </h1>
                </div>
                                ...
                                <div class="panel-content" data-select2-id="36">
                                    ...
                                    <div class="form-group" data-select2-id="100">
                                        ...
                                        <select required name="category_id"
                                                ...
                                                id="single-default" data-select2-id="single-default" tabindex="-1"
                                                aria-hidden="true">
                                            ...
                                            dir="ltr" data-select2-id="1" style="width: 551.4px;"><span
                                                class="selection"><span
                                                    ...
                                                    aria-labelledby="select2-single-default-container"><span
                                                        ...
                                                        id="select2-single-default-container" role="textbox"
