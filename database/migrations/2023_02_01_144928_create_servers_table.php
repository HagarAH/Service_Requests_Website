...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('servers', function (Blueprint $table) {
            ...
            $table->index('notification_id', 'server_notification_idx');
            ...
            $table->foreign('notification_id', 'server_notification_fk')->references('id')->on('notifications')->onDelete('cascade');
